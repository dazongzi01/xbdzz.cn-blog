...
> 本文档详细介绍 Java商城系统 多商户 V1.9+ 版本中 wxJava 框架的配置方法和迁移说明
...
从 V1.9 版本开始，Java商城系统 将微信相关的所有内容切换为使用 **wxJava 框架**实现，配置方式从后台页面配置改为 YAML 文件配置。
...
**注意：** 本系统 商户版目前默认支持单个应用配置，多账号需要代码适配。
