...
1. 在宝塔点"文件"
2. 进入 `/www/wwwroot/system-admin/` 目录
3. 点"上传"
4. 选择整个 `dist` 文件夹
5. 等待上传
...
- `admin.yoursite.com` → `/www/wwwroot/system-admin`
- `admin2.yoursite.com` → `/www/wwwroot/system-admin2`
...
1. 部署 H5 商城（参考[H5打包](/01_初步了解/10_代码H5打包)）
2. 初始化商品和分类
3. 配置营销功能
4. 邀请商家或用户
